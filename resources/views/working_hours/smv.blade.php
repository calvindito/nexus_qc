        ...
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">SMV</span>
                </h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">SMV</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="product_class" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Type Product :</label>
                                <input type="text" id="product_type" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script>
    ...
    function getDataStyle() {
        $.ajax({
            url: '{{ url("working_hours/smv/get_data_style") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: $('#style_id').val()
            ...
            success: function(response) {
                ...
                $('#product_class').val(response.product_class);
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            order: [[1, 'asc']],
            ajax: {
                url: '{{ url("working_hours/smv/datatable") }}',
                type: 'GET',
                beforeSend: function() {
            ...
            columns: [
                ...
                { name: 'product_type_id', orderable: false, className: 'text-center align-middle' },
                { name: 'style_id', className: 'text-center align-middle' },
                { name: 'target', searchable: false, className: 'text-center align-middle' },
                { name: 'smv_global', searchable: false, orderable: false, className: 'text-center align-middle' },
                { name: 'smv_style', searchable: false, orderable: false, className: 'text-center align-middle' },
    ...
    function create() {
        $.ajax({
            url: '{{ url("working_hours/smv/create") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function show(id) {
        toShow();
        $.ajax({
            url: '{{ url("working_hours/smv/show") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("working_hours/smv/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("working_hours/smv/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
        ...
        var notify_confirmation = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Delete', 'btn btn-danger btn-sm ml-1', function() {
                    $.ajax({
                        url: '{{ url("working_hours/smv/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
