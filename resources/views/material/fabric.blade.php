                    ...
                    <div class="form-group">
                        ...
                        <div class="d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="{{ url('download/excel/fabric') }}" target="_blank" class="dropdown-item"><i class="icon-file-excel"></i> Export Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="javascript:void(0);" class="breadcrumb-item">Material</a>
            ...
            <div class="modal-body">
                <form id="form_data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter fabric">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            order: [[1, 'asc']],
            ajax: {
                url: '{{ url("material/fabric/datatable") }}',
                type: 'GET',
                beforeSend: function() {
    ...
    function create() {
        $.ajax({
            url: '{{ url("material/fabric/create") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("material/fabric/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("material/fabric/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
        ...
        var notify_confirmation = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Delete', 'btn btn-danger btn-sm ml-1', function() {
                    $.ajax({
                        url: '{{ url("material/fabric/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
