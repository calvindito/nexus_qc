        ...
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Critical Issues</span>
                </h4>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ url('download/pdf/critical_issues') }}" target="_blank" class="dropdown-item"><i class="icon-printer"></i> Print</a>
                                <a href="{{ url('download/excel/critical_issues') }}" target="_blank" class="dropdown-item"><i class="icon-file-excel"></i> Export Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Critical Issues</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_data" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label>Critical Issues :<span class="text-danger">*</span></label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter critical issues">
                    </div>
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            order: [[1, 'asc']],
            ajax: {
                url: '{{ url("group_defect/critical_issues/datatable") }}',
                type: 'GET',
                beforeSend: function() {
    ...
    function create() {
        $.ajax({
            url: '{{ url("group_defect/critical_issues/create") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function show(id) {
        toShow();
        $.ajax({
            url: '{{ url("group_defect/critical_issues/show") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("group_defect/critical_issues/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("group_defect/critical_issues/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
        ...
        var notify_confirmation = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Delete', 'btn btn-danger btn-sm ml-1', function() {
                    $.ajax({
                        url: '{{ url("group_defect/critical_issues/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
