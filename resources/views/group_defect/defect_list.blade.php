                    ...
                    <div class="form-group">
                        ...
                        <div class="d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="{{ url('download/excel/defect_list') }}" target="_blank" class="dropdown-item"><i class="icon-file-excel"></i> Export Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="form_data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter defect">
                    </div>
...
<script>
    ...
    function show(id) {
        toShow();
        $.ajax({
            url: '{{ url("group_defect/defect_list/show") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("group_defect/defect_list/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("group_defect/defect_list/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
        ...
        var notify_confirmation = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Delete', 'btn btn-danger btn-sm ml-1', function() {
                    $.ajax({
                        url: '{{ url("group_defect/defect_list/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
