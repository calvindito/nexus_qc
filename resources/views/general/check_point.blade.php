        ...
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Check Point</span>
                </h4>
            ...
            <div class="modal-body">
                <form id="form_data" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label>Check Point :<span class="text-danger">*</span></label>
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            order: [[0, 'asc']],
            ajax: {
                url: '{{ url("general/check_point/datatable") }}',
                type: 'GET',
                beforeSend: function() {
    ...
    function create() {
        $.ajax({
            url: '{{ url("general/check_point/create") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function show(id) {
        toShow();
        $.ajax({
            url: '{{ url("general/check_point/show") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("general/check_point/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("general/check_point/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
        ...
        var notify_confirmation = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Delete', 'btn btn-danger btn-sm ml-1', function() {
                    $.ajax({
                        url: '{{ url("general/check_point/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
