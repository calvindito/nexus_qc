                    ...
                    <div class="form-group">
                        ...
                        <div class="d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="{{ url('download/excel/class_product') }}" target="_blank" class="dropdown-item"><i class="icon-file-excel"></i> Export Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="form_data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter class product">
                    </div>
