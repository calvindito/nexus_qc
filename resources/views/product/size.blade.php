                    ...
                    <div class="form-group">
                        ...
                        <div class="d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ url('download/pdf/size') }}" target="_blank" class="dropdown-item"><i class="icon-printer"></i> Print</a>
                                <a href="{{ url('download/excel/size') }}" target="_blank" class="dropdown-item"><i class="icon-file-excel"></i> Export Excel</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function loadDataTable() {
        $('#datatable_serverside').DataTable({
            ...
            order: [[1, 'asc']],
            ajax: {
                url: '{{ url("product/size/datatable") }}',
                type: 'GET',
                beforeSend: function() {
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("product/size/update") }}' + '/' + id,
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
    ...
    function changeStatus(id, value) {
        $.ajax({
            url: '{{ url("product/size/change_status") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id,
