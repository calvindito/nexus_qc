<table>
    <thead>
        <tr>
            <th rowspan="2" colspan="5" style="font-size:15px; font-weight:bold; border:1px solid black; text-align:center; vertical-align:center; width:100%;">NEXUS QUALITY CONTROL - DEFECT</th>
        </tr>
    </thead>
</table><br>
