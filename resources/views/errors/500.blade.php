				...
				<div class="content d-flex justify-content-center align-items-center">
					<div class="flex-fill">
						<div class="text-center mb-4">
							...
							<h1 class="display-3 font-weight-semibold line-height-1 mb-2">500</h1>
							<h5>Oops, an error has occurred. <br> The server encountered an internal error and was unable to complete your request.</h5>
						</div>
